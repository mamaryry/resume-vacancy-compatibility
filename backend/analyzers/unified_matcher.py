...
class UnifiedSkillMatcher:
    ...
    1. Улучшенное сопоставление: прямое, синонимы, нечёткое, составных навыков
    2. Сопоставление TF-IDF: взвешенная оценка на основе важности ключевых слов
    3. Векторное сопоставление: семантическое сходство с использованием эмбеддингов
    ...
    def __init__(
        ...
        Args:
            keyword_weight: Вес сопоставления ключевых слов в общей оценке
            tfidf_weight: Вес сопоставления TF-IDF в общей оценке
            vector_weight: Вес векторного сопоставления в общей оценке
